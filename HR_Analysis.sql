...
SELECT Salary_Group, COUNT(Employee_ID) AS Attrition_by_Salary_Group FROM employees 
WHERE Attrition = 'Yes'
...
ORDER BY Attrition_per_Experince_Range DESC;

-- Experience Range with the highest attrition
SELECT Experience_Range, COUNT(Employee_ID) AS Attrition_per_Experience_Range 
FROM employees 
WHERE Attrition = 'Yes'
GROUP BY Experience_Range 
...
SELECT Job_Satisfaction, COUNT(Employee_ID) AS Attrition_by_Job_Satisfaction 
FROM employees 
WHERE Attrition = 'Yes'
